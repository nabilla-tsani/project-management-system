...
@if($modalOpen)
    ...
    >
        <div class="bg-white p-6 w-full max-w-3xl shadow-xl flex gap-6">
                    ...
                    <ul class="text-xs">
                        @if($fiturUsers->isNotEmpty())
                            @foreach($fiturUsers as $index => $fu)
                                <li class="border-b py-3 text-xs">
                                    <div class="flex items-center text-xs">
                                        <!-- <span class="w-10 text-gray-700">{{ $index + 1 }}</span> -->
            ...
            <div class="w-1/3">
                ...
                {{-- FORM --}}
                <form wire:submit.prevent="save" class="space-y-3 text-[13px]">
