...
@if($modalOpen)
    ...
    >
                ...
                <div class="w-2/3 border-r pr-5">
                        ...
                        <ul class="text-xs">
                            @if($fiturUsers->isNotEmpty())
                                @foreach($fiturUsers as $index => $fu)
                                    <li wire:key="fu-{{ $fu->id }}" class="border-b py-3">
                                ...
                                @endforeach
                            @else
                                <li class="py-3 text-center text-gray-400 italic">No one’s on this feature yet.</li>
                            @endif
                        </ul>
                    </div>
                    ...
                    <div class="flex justify-end mt-1">
                        <button 
                            ...
                            class="text-xs bg-gray-300 hover:bg-gray-400 px-4 py-2 rounded-3xl"
                        >
                            Close
                        </button>
                    </div>
        ...
        {{-- ======================= NON-MANAGER VIEW (Read Only) ======================= --}}
        @else
            <div class="bg-white p-6 w-2/5 max-w-3xl shadow-xl" wire:key="modal-{{ $proyekFiturId ?? 'new' }}">
